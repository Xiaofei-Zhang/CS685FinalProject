...
class GAN():
    ...
    def train(self, epochs, batch_size=128, save_interval=50):
        ...
        print(X_train.shape)
        # Rescale -1 to 1
        X_train = (X_train.astype(np.float32) - 500) / 500
    ...
    def save_data(self, epoch):
        ...
        for i in range(number_to_gen):
            a = int(gen_data[i][0][0] * 500 + 500)
            b = int(gen_data[i][1][0] * 500 + 500)
            c = int(gen_data[i][2][0] * 500 + 500)
